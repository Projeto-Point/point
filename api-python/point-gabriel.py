...
from psutil import (virtual_memory, cpu_percent,
                    disk_usage, users, pids, cpu_count)
import psutil
import pymssql
import geocoder
import pymysql
...
ip = geocoder.ip('me')
inserirBanco(
    f"INSERT INTO Localizacao (dataEntrada, ipAdress, longitude, latitude, cidade, pais, fkMaquina) VALUES (GETDATE() AT TIME ZONE 'UTC' AT TIME ZONE 'Bahia Standard Time', '{ip.ip}', {ip.latlng[0]}, {ip.latlng[1]}, '{ip.city}', '{ip.country}', {idMaquina})")
